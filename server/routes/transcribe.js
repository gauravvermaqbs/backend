...
router.post(
  ...
  async function (req, res) {
    ...
    await openai
      .createTranscription(audio, model, transcript_mode, response_format)
      .then((resp) => {
...
router.post(
  ...
  async function (req, res) {
    ...
    await openai
      .createTranscription(video, model, transcript_mode, response_format)
      .then((resp) => {
        res.send(resp.data);
      })
      .catch((err) => {
...
router.post(
  ...
  async function (req, res) {
    ...
    await openai
      .createTranscription(audio, model)
      .then((resp) => {
